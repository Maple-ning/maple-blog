...
const heroStats = computed(() => ({
  ...
  latest: formatDate(
    insightItems.value[0]?.publishedAt || insightItems.value[0]?.updatedAt || "",
  ),
}));
</script>
      ...
      <div class="container projects-page__content">
        <div v-if="sortedInsights.length" class="grid grid--1">
          <article
            ...
            :key="item.id"
            class="post-card post-card--insight insight-card"
          >
            <div v-if="item.pinned" class="insight-pin-badge">
